											...
											<tr>
												<td class="text-pad">
													<p>Dear {contact.display_name},</p>
														<p>{ts 1=$event.event_title}Your pending event registration for %1 has expired because you did not confirm your registration.{/ts}</p>
													<p>{ts 1=$domain.phone 2=$domain.email}Please contact us at %1 or send email to %2 if you have questions or want to inquire about reinstating your registration for this event.{/ts}</p>
												</td>
										</tr>
									</table>
								</td>
